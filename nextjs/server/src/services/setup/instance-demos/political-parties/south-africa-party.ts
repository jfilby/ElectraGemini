...
export class SouthAfricaPartyDemoSetupService {

  // Consts
  clName = 'SouthAfricaPartyDemoSetupService'
  ...
  async setup(
    ...
    const instance = await
            this.instanceModel.upsert(
              ...
              userProfile.id,
              BaseDataTypes.electraAiPartyForSouthAfrica)
